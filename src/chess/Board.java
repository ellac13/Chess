...
public class Board {
	...
	/**
	 * Return a int indicating wither square at row r and column c is occupied.
	 ...
	 */
	//TODO: All methods that change board positions must create new possible moves for all pieces
